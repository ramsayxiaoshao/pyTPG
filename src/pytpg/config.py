...
from pytpg.evolution.initialization import GraphInitializer, InitializationConfig
from pytpg.evolution.mutation import MutationConfig, default_mutation
from pytpg.evolution.reproduction import Reproducer, ReproductionConfig
from pytpg.evolution.selection import TournamentSelection
...
class TPGConfig:
    ...
    def create_initializer(
        ...
        from pytpg.evolution.initialization import GraphInitializer
